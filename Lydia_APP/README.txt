...
**Feature Extraction**: The images are processed through the EfficientNet model to obtain a 2048-dimensional feature vector for each image. 
...
**API Framework**: FastAPI is faster to use than flask in my case.
